...
export class PersonagemView {
    ...
    constructor(personagens) {
        ...
        this.personagens = personagens // array que está no index.js que passas as propriedades dessa classe para os seus elementos
        this.personagensSelecionados = []
        this.escutarEventoDuelo()
    }

    render() { // Não se coloca a palavra "function"dentro das classes, escrito como está já é interpretado como um metodo desta.
